...
import com.neptunes.dto.GraphQLRequest;
import com.neptunes.dto.perfume.PerfumeRequest;
...
public class AdminControllerTest {
    ...
    public void getUserOrdersByEmail() throws Exception {
        mockMvc.perform(get(API_V1_ADMIN + ORDER_BY_EMAIL, TestConstants.USER_EMAIL)
                        .contentType(MediaType.APPLICATION_JSON_VALUE))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$[*].id").isNotEmpty())
                .andExpect(jsonPath("$[*].totalPrice", Matchers.hasItem( TestConstants.TOTAL_PRICE)))
    ...
    public void getUserById() throws Exception {
        mockMvc.perform(get(API_V1_ADMIN + USER_BY_ID, TestConstants.USER_ID)
                        .contentType(MediaType.APPLICATION_JSON_VALUE))
                .andExpect(status().isOk())
